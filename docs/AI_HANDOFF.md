...
- `supabase/migrations/20260818041500_writer_registry.sql` — adds the writer registry and replaces `dcal_save_task`; the Writer inspector section errors until it is applied.
